...
export default function Home() {
  return (
    <div>
      <section className=" z-50 headSection">
        <Nav />
        <div className="pt-20 px-4 mx-auto max-w-screen-xl text-center ">
      ...
      <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div
            className="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl mt-4 text-xl font-bold text-black"
          >
