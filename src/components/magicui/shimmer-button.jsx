...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    (<button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-5 py-2 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
      ...
      <div
        className={cn(
          ...
          // on hover
          "group-hover:shadow-[inset_0_0px_10px_#ffffff]",
          // on click
